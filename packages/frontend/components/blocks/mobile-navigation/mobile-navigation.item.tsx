...
export const MobileNavigationItem = ({
  ...
  return (
    <li
      className={mobileNavigationItemClasses}
      data-testid={"mobile-navigation-list-item"}
    >
      <Link
        ...
        activeClassName={clsx(
          "fill-peal-lusta font-bold text-peal-lusta before:!block"
        )}
      >
        {iconName && (
          <Icon
            icon={iconName}
            className="h-4 w-4"
            testId="mobile-navigation-link-icon"
          />
        )}
